...
{path: 'rezervation', component: RezervationComponent,canActivate:[AuthenticationGuard], canLoad:[UserCheckGuard], loadChildren: () => import('./user-panel/user-panel.module').then(m => m.UserPanelModule)},
